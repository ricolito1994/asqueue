...
const QueueListCard: React.FC<any> = (): React.ReactElement => {
  return (
    <div className="flex flex-col bg-white border border-[#dde4ef] rounded-xl overflow-hidden h-full">
      ...
      {/* Filter pills - uncomment to implement filtering if needed */}
            ...
            {mockRows.map((row) => (
              ...
              >
                ...
                <td className="px-4 py-2.5">
                  <span
                    className={`inline-block text-[11px] font-medium px-2.5 py-1 rounded-full capitalize ${statusStyles[row.status]}`}
                  >
                    {row.status}
                  </span>
                </td>
